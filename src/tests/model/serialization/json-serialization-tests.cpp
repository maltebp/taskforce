...
TEST(json_serialization, nested_primitives) {
    ...
    NestingTypes object_to_serialize{
        Primitives{ 42, 42'000'000'000'000, 1.234f, 2.345678, true, "Hello, world!"},
        {
            Primitives{ 42, 42'000'000'000'000, 1.234f, 2.345678, true, "First element"},
            Primitives{ 42, 42'000'000'000'000, 1.234f, 2.345678, true, "Second element"},
            Primitives{ 42, 42'000'000'000'000, 1.234f, 2.345678, true, "Third element"},
        }
    };
    write_then_read_and_assert(object_to_serialize);
}
...
TEST(json_serialization, optional_values) {
    ...
    AllOptionalValues object_with_values{
        ...
        true,
        "Hello, world!",
        Primitives{1337, 123'000'000'000, 10.1234f, 2.345678, true, "Nested string"},
        { 
            Primitives{ 42, 42'000'000'000'000, 1.234f, 2.345678, true, "First element"},
            Primitives{ 42, 42'000'000'000'000, 1.234f, 2.345678, true, "Second element"},
        }
